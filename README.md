...
## Environments
- Preview: https://main--eds-nrma-universal--pratikvaidya26.aem.page/
- Live: https://main--eds-nrma-universal--pratikvaidya26.aem.live/
...
1. Open the `eds-nrma-universal` directory in your favorite IDE and start coding :)
